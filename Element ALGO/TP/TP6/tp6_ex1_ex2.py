...
class TableHachage:
    ...
    # retourne le haché (stocké) de la ième clé si il y a une clé et lève une exception sinon
    def getHash(self, i):
        if self.estVide(i) or self.estMarquee(i): raise ValueError('pas de clé!')
...
## redondant avec la méthode positionsSuccessives
## (pour cohérence avec les deux versions de l'énoncé)
